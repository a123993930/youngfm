package com.itianyi.modules.task.service.impl;

import com.itianyi.core.common.service.impl.CommonServiceImpl;
import com.itianyi.core.quartz.QuartzManager;
import com.itianyi.modules.task.entity.ScheduleJob;
import com.itianyi.modules.task.mapper.ScheduleJobMapper;
import com.itianyi.modules.task.service.IScheduleJobService;
import com.itianyi.modules.task.utils.ScheduleJobUtils;
...
public class ScheduleJobServiceImpl extends CommonServiceImpl<ScheduleJobMapper, ScheduleJob>
	...
	public void updateCron(String jobId) throws SchedulerException {
		...
		if (com.itianyi.core.quartz.data.ScheduleJob.STATUS_RUNNING.equals(scheduleJob.getJobStatus())) {
	...
	public void changeStatus(String jobId, String cmd) throws SchedulerException {
		...
		if ("stop".equals(cmd)) {
			...
			scheduleJob.setJobStatus(com.itianyi.core.quartz.data.ScheduleJob.STATUS_NOT_RUNNING);
		} else if ("start".equals(cmd)) {
			scheduleJob.setJobStatus(com.itianyi.core.quartz.data.ScheduleJob.STATUS_RUNNING);
