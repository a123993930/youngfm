...
import com.itianyi.core.disruptor.sms.SmsEvent.SmsHandlerCallBack;
import com.itianyi.core.disruptor.sms.SmsHelper;
...
import com.itianyi.modules.sms.service.ISmsSendService;
...
public class SmsSendServiceImpl implements ISmsSendService {
	...
	public void sendAsyncSmsByCode(String phone, String code, SmsHandlerCallBack callBack, String... datas) {
		...
		com.itianyi.core.utils.sms.data.SmsTemplate template = com.itianyi.core.utils.sms.data.SmsTemplate.newTemplate(templateId, templateContent);
	...
	public void sendAsyncSmsByContent(String phone, String content, SmsHandlerCallBack callBack, String... datas) {
		com.itianyi.core.utils.sms.data.SmsTemplate template = com.itianyi.core.utils.sms.data.SmsTemplate.newTemplateByContent(content);
		SpringContextHolder.getBean(SmsHelper.class).sendAsyncSms(phone, template, callBack, datas);
	}
