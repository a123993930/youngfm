package com.itianyi.core.query.parse;
...
import com.itianyi.core.query.data.Condition;
import com.itianyi.core.query.data.Condition.Filter;
import com.itianyi.core.query.data.Condition.Operator;
...
public class QueryToWrapper<T> {
	...
	public void parseSort(Wrapper<T> wrapper, Queryable queryable) {
		com.itianyi.core.query.data.Sort sort = queryable.getPageable().getSort();
		if (sort != null) {
			for (com.itianyi.core.query.data.Sort.Order order : sort) {
				if (order.getDirection() == com.itianyi.core.query.data.Sort.Direction.DESC) {
					wrapper.orderBy(order.getProperty(), false);
				} else if (order.getDirection() == com.itianyi.core.query.data.Sort.Direction.ASC) {
