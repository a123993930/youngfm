package com.itianyi.core.tags.html.resolver;
...
public class HtmlComponentDTDEntityResolver implements EntityResolver, Serializable {
	...
	private static final String HOP_DYNAMIC_STATEMENT = "http://www.itianyi.com/dtd/";
	...
	public InputSource resolveEntity(String publicId, String systemId) {
		...
		if (systemId != null) {
			...
			if (systemId.startsWith(HOP_DYNAMIC_STATEMENT)) {
				LOGGER.debug(
						"recognized hop html component namespace attempting to resolve on classpath under com.itianyi.core/tags/html/dtd/");
	...
	private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
		...
		String path = "com/itianyi/core/tags/html/dtd/" + systemId.substring(namespace.length());
