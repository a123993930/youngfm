package com.itianyi.core.disruptor.email;
...
public class EmailEventProducer {
	...
	private void sendEmail(EmailData emailData, EmailEvent.EmailHandlerCallBack callBack) {
		// 获取下一个序号
	...
	public void sendEmail(String email, String content, EmailEvent.EmailHandlerCallBack callBack, String... datas) {
	...
	public void sendEmail(String email, String subject, String content, EmailEvent.EmailHandlerCallBack callBack,
			String... datas) {
