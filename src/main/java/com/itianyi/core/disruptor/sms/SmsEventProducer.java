...
public class SmsEventProducer {
	...
	private void sendSms(SmsData smsData, SmsEvent.SmsHandlerCallBack callBack) {
		// 获取下一个序号
	...
	public void sendSms(String phone, SmsTemplate smsTemplate, SmsEvent.SmsHandlerCallBack callBack, String... datas) {
		SmsData smsData = new SmsData();
		smsData.setPhone(phone);
		smsData.setSmsTemplate(smsTemplate);
		smsData.setDatas(datas);
